...
resource "aws_codedeploy_app" "tf-application" {
...
resource "aws_codedeploy_deployment_group" "tf-deployment-group" {
  app_name               = aws_codedeploy_app.tf-application.name
  deployment_group_name  = "tf-deplyment-group"
 ...
 blue_green_deployment_config {
  ...
  ecs_service {
    ...
    service_name = "${aws_ecs_service.tf-ecs-service.name}"
  }
